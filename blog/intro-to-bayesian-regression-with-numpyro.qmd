...
image: '/static/images/numpyro_regression/plot_lm.png'
layout: PostLayout
# canonicalUrl:
---
...
![Simulated Data](/static/images/numpyro_regression/sim_data.png)
...
![Rendered Model](/static/images/numpyro_regression/numpyro_reg_graph.svg)
...
### Click here to see the same model in `pymc`
...
![az.plot_trace output](/static/images/numpyro_regression/plot_trace.png)
...
![az.plot_lm() output](/static/images/numpyro_regression/plot_lm.png)
